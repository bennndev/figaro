...
<nav class="flex flex-col justify-between h-full p-4 bg-gray-800 text-white">
    <!-- Menú -->
    <div class="space-y-3">
        <a href="{{ route('inicio') }}" class="flex items-center px-5 py-4 rounded text-xl transition {{ isActive('inicio') }}">
        ...
        <a href="{{ route('barberos') }}" class="flex items-center px-5 py-4 rounded text-xl transition {{ isActive('barberos') }}">
            <i class="bi bi-scissors mr-4 text-2xl"></i> Barberos
        </a>

        <a href="{{ route('servicios') }}" class="flex items-center px-5 py-4 rounded text-xl transition {{ isActive('servicios') }}">
            <i class="bi bi-bag-check-fill mr-4 text-2xl"></i> Servicios
        </a>

        <a href="{{ route('facturas') }}" class="flex items-center px-5 py-4 rounded text-xl transition {{ isActive('facturas') }}">
            <i class="bi bi-receipt-cutoff mr-4 text-2xl"></i> Facturas
        </a>

        <a href="{{ route('reservas') }}" class="flex items-center px-5 py-4 rounded text-xl transition {{ isActive('reservas') }}">
