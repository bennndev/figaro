<x-admin-app-layout>
    ...
    <div class="py-10 min-h-screen bg-[#181818] text-white">
        <div class="max-w-7xl mx-auto px-4">
            {{-- KPIs --}}
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
                <div class="bg-[#232323] rounded-xl p-6 shadow flex flex-col items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                {{-- Gráfica de reservas --}}
                <div class="bg-[#232323] rounded-xl p-6 shadow">
                        ...
                        @foreach($ultimas as $r)
                            <li class="mb-3 border-b border-gray-700 pb-2">
                                ...
                                <span class="ml-2 text-xs px-2 py-1 rounded-lg font-bold
                                    @if($r->status === 'paid') bg-white text-black @elseif($r->status === 'pending_pay') bg-gray-700 text-white @elseif($r->status === 'cancelled') bg-[#232323] text-gray-400 border border-gray-600 @elseif($r->status === 'completed') bg-black text-white @else bg-gray-800 text-white @endif">
                                    {{ ucfirst($r->status) }}
                                </span>
                            </li>
                        @endforeach
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                {{-- KPIs adicionales --}}
                <div class="bg-[#232323] rounded-xl p-6 shadow mb-8">
