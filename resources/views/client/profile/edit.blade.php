<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-white leading-tight flex items-center space-x-2">
            ...
            <a href="{{ route('dashboard') }}" class="text-white hover:underline">Inicio</a>
        </h2>
    </x-slot>
            ...
            <div class="bg-[#2A2A2A] shadow-md rounded-xl text-white border border-white/10 overflow-hidden">
                ...
                <div class="bg- px-6 py-8">
                    <div class="flex items-center space-x-6">
                        ...
                        <div class="flex-1">
                            <h1 class="text-3xl font-bold text-white">{{ Auth::user()->name }} {{ Auth::user()->last_name }}</h1>
                            <p class="text-white/70 text-lg">{{ Auth::user()->email }}</p>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="bg-[#1E1E1E] p-3 rounded-lg border border-white/10">
                                <span class="text-white">{{ Auth::user()->last_name ?? 'No especificado' }}</span>
                            </div>
                        </div>
